...
export default function ModerationPage() {
  ...
  const handleDelete = () => {
    ...
    } else if (deleteTarget.type === 'POST' || deleteTarget.type === 'RESOURCE_POST' || deleteTarget.type === 'CHANNEL_POST') {
  ...
  if (!isModerator) {
    return (
      <>
        <Seo title="Moderation — LernChih" canonicalPath="/moderation" robots="noindex, nofollow" />
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.headerRow}>
        <Shield24Regular />
        <Title2 as="h1">Moderation Dashboard</Title2>
      </div>
