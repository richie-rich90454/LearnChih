    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/resources/leaderboard").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/channels").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/channels/{id}").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/channels/{id}/threads").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/channels/threads/{threadId}/posts").permitAll()
