...
import { ArrowLeft24Regular, ArrowRight24Regular, ArrowRotateClockwise24Regular } from '@fluentui/react-icons'
  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <Caption1 style={{ marginTop: tokens.spacingVerticalM, color: tokens.colorNeutralForeground3 }}>
      ...
      <div className={styles.controls}>
        ...
        <Button appearance="subtle" icon={<ArrowRotateClockwise24Regular />} onClick={() => setFlipped((f) => !f)}>
          Flip
        </Button>
